<script lang="ts">
	import DrawerCode from '$lib/ui/drawer/Drawer.svelte?raw'
...
<DocSection title="Drawer" description="TODO: write a small description">
	<DocProps props={parseProps(DrawerCode)} />
